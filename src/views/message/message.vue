...
export default {
  ...
  data() {
    return {
      titleC:"行业资讯",
      sideNav: [
        { title: "建设要闻", url: "", img: "icon-jianjie" },
        { title: "公示公告", url: "", img: "icon-wendang1" },
        { title: "行业标准", url: "", img: "icon-dongtai-miaobian" },
        { title: "行业研究", url: "", img: "icon-dianhua" },
        { title: "行业动态", url: "", img: "icon-dianhua" },
      ],
      sideNavSel: 0,
      dataList: [
